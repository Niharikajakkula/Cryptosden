...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (oauthError === 'oauth_failed') {
      setError('Google/Facebook login failed. Please try again or use email/password.');
    }
  }, [searchParams]);
  ...
  const handleGoogleLogin = () => {
    // Must use full backend URL - proxy does not apply to window.location
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-300 text-lg">Welcome back to your crypto platform</p>
          </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-8 shadow-2xl">
            ...
            <div className="mt-8 space-y-4">
              ...
              <button
                ...
                className="w-full bg-slate-700/50 border border-slate-600/50 text-white py-3 px-4 rounded-lg font-medium hover:bg-slate-700/70 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 focus:ring-offset-slate-800 transition-all duration-200"
              >
                Create New Account
              </button>
            </div>
